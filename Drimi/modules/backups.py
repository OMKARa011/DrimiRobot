...
# from Drimi.modules.sql import warns_sql as warnssql
import Drimi.modules.sql.blacklist_sql as blacklistsql

# from Drimi.modules.sql import cust_filters_sql as filtersql
# import Drimi.modules.sql.welcome_sql as welcsql
import Drimi.modules.sql.locks_sql as locksql
import Drimi.modules.sql.notes_sql as sql

# from Drimi.modules.rules import get_rules
import Drimi.modules.sql.rules_sql as rulessql
from Drimi import JOIN_LOGGER, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from Drimi.__main__ import DATA_IMPORT
from Drimi.modules.connection import connected
from Drimi.modules.helper_funcs.alternate import typing_action
from Drimi.modules.helper_funcs.chat_status import user_admin
from Drimi.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("Drimi-Drimi{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Drimi-Drimi{}.backup".format(chat_id), "rb"),
        caption="*sᴜᴄᴄᴇssғᴜʟʟʏ ᴇxᴘᴏʀᴛᴇᴅ ʙᴀᴄᴋᴜᴘ:*\nᴄʜᴀᴛ: `{}`\nᴄʜᴀᴛ ɪᴅ: `{}`\nᴏɴ: `{}`\n\nɴᴏᴛᴇ: ᴛʜɪs `Drimi-Drimi-Backup` ᴡᴀs sᴘᴇᴄɪᴀʟʟʏ ᴍᴀᴅᴇ ғᴏʀ ɴᴏᴛᴇs.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Drimi-Drimi{}.backup".format(chat_id))  # Cleaning file
