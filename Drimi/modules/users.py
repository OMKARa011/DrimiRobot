...
import Drimi.modules.no_sql.users_db as user_db
from Drimi import DEV_USERS, LOGGER, OWNER_ID, dispatcher
from Drimi.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from Drimi.modules.helper_funcs.decorators import Drimicmd, Drimimsg
from Drimi.modules.no_sql.users_db import get_all_users
...
@Drimicmd(command=["broadcastall", "broadcastusers", "broadcastgroups"])
@dev_plus
...
@Drimimsg((Filters.all & Filters.chat_type.groups), group=USERS_GROUP)
...
@Drimimsg((Filters.all & Filters.chat_type.groups), group=CHAT_GROUP)
