...
import Drimi.modules.sql.userinfo_sql as sql
from Drimi import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Drimi import telethn as Drimi
from Drimi.__main__ import STATS, TOKEN, USER_INFO
from Drimi.modules.helper_funcs.chat_status import sudo_plus
from Drimi.modules.helper_funcs.decorators import Drimicallback, Drimicmd
from Drimi.modules.helper_funcs.extraction import extract_user
from Drimi.modules.no_sql.global_bans_db import is_user_gbanned
from Drimi.modules.no_sql.users_db import get_user_num_chats
from Drimi.modules.sql import SESSION
...
def set_about_me(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if repl_user_id in [bot.id, 777000] and (user_id in DEV_USERS):
...
@Drimicmd(command="stats", can_disable=True)
@sudo_plus
...
@Drimicallback(pattern=r"^pingCB")
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id in [777000] and sender_id not in DEV_USERS:
