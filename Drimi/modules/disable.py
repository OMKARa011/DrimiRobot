...
from Drimi.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
...
if is_module_loaded(FILENAME):
    ...
    from Drimi.modules.sql import disable_sql as sql
        ...
        def check_update(self, update):
            ...
            if message.text and len(message.text) > 1:
                ...
                if len(fst_word) > 1 and any(
                    ...
                    user_id = chat.id if user.id == 6108024586 else user.id
    ...
    def disable_module(update: Update, context: CallbackContext):
        ...
        chat = update.effective_chat
        if len(args) >= 1:
            disable_module = "Drimi.modules." + args[0].rsplit(".", 1)[0]
    ...
    def enable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            enable_module = "Drimi.modules." + args[0].rsplit(".", 1)[0]
