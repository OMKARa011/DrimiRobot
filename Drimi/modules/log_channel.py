...
from Drimi.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Drimi import EVENT_LOGS, LOGGER, dispatcher
    ...
    from Drimi.modules.sql import log_channel_sql as sql
...
@Drimicallback(pattern=r"log_tog_.*")
