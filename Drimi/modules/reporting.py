...
from Drimi import DRAGONS, LOGGER, TIGERS, WOLVES
...
from Drimi.modules.sql import reporting_sql as sql
...
@Drimicmd(command="report", filters=Filters.chat_type.groups, group=REPORT_GROUP)
@Drimimsg((Filters.regex(r"(?i)@admin(s)?")), group=REPORT_GROUP)
@user_not_admin
@loggable
...
@Drimicallback(pattern=r"report_")
