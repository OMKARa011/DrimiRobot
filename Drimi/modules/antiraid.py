...
from Drimi.modules.cron_jobs import j
from Drimi.modules.helper_funcs.anonymous import AdminPerms
from Drimi.modules.helper_funcs.anonymous import resolve_user as res_user
from Drimi.modules.helper_funcs.anonymous import user_admin as u_admin
from Drimi.modules.helper_funcs.chat_status import connection_status, user_admin_no_reply
...
@Drimicmd(command="raid", pass_args=True)
@connection_status
@loggable
...
@Drimicallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@Drimicallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@Drimicallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@Drimicmd(command="raidactiontime", pass_args=True)
@connection_status
@u_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
