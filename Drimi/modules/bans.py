...
from Drimi.modules.helper_funcs.chat_status import user_admin_no_reply, user_can_ban
from Drimi.modules.helper_funcs.extraction import extract_user_and_text
...
from Drimi.modules.log_channel import gloggable, loggable


# @Drimicmd(command=["ban", "sban", "dban"], pass_args=True)
@connection_status
@bot_admin
@can_restrict
