...
from Drimi import Zadkiel as Drimi
from Drimi import StartTime, dispatcher
from Drimi.modules.disable import DisableAbleCommandHandler
from Drimi.modules.helper_funcs.chat_status import sudo_plus
from Drimi.modules.stats import bot_sys_stats as nagisa
...
@Drimi.on_callback_query(filters.regex("stats_callback"))
async def stats_callback(_, CallbackQuery):
    text = await nagisa()
    await Drimi.answer_callback_query(CallbackQuery.id, text, show_alert=True)
