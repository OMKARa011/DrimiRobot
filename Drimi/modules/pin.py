...
from Drimi import Zadkiel
from Drimi.modules.no_sql import AsuXdb as db
from Drimi.utils.pluginhelp import member_permissions
...
@Zadkiel.on_message(filters.command("unpinall") & ~filters.private)
...
@Zadkiel.on_message(filters.command("antichannelpin") & ~filters.private)
...
@Zadkiel.on_message(filters.command("cleanlinked") & ~filters.private)
...
@Zadkiel.on_message(filters.command("permapin") & ~filters.private)
...
@Zadkiel.on_message(filters.linked_channel)
