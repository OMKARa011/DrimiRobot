...
from Drimi import OWNER_ID, SUPPORT_CHAT
from Drimi import telethn as tbot
...
"""
    ...
    await tbot.send_message(
        SUPPORT_CHAT,
        f"{logger_text}",
        file=random.choice(Drimi),
        link_preview=False,
    )
    await e.reply(TEXT, file=random.choice(Drimi), buttons=BUTTON)
