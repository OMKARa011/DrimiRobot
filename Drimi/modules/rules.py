...
import Drimi.modules.sql.rules_sql as sql
...
@Drimicmd(command="rules", filters=Filters.chat_type.groups)
...
@Drimicmd(command="setrules", filters=Filters.chat_type.groups)
...
@Drimicmd(command="clearrules", filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
