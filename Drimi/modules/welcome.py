...
import Drimi.modules.sql.log_channel_sql as logsql
import Drimi.modules.sql.welcome_sql as sql
from Drimi import DEMONS, DEV_USERS, DRAGONS, LOGGER, OWNER_ID
from Drimi import SUPPORT_CHAT as Chatting_hub51
from Drimi import WOLVES, dispatcher, sw
from Drimi.modules.helper_funcs.anonymous import AdminPerms, user_admin
from Drimi.modules.helper_funcs.chat_status import is_user_ban_protected
from Drimi.modules.helper_funcs.chat_status import user_admin as u_admin
from Drimi.modules.helper_funcs.decorators import Drimicallback, Drimicmd, Drimimsg
from Drimi.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Drimi.modules.helper_funcs.msg_types import get_welcome_type
from Drimi.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Drimi.modules.log_channel import loggable
from Drimi.modules.no_sql.global_bans_db import is_user_gbanned
...
@Drimimsg((Filters.status_update.new_chat_members), group=WELCOME_GROUP)
@loggable
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    f"ᴛʜᴀɴᴋꜱ ꜰᴏʀ ᴀᴅᴅɪɴɢ ᴍᴇ! ᴊᴏɪɴ @{Chatting_hub51} ꜰᴏʀ ꜱᴜᴘᴘᴏʀᴛ.",
                    reply_to_message_id=reply,
                )
                continue
...
@Drimimsg((Filters.status_update.left_chat_member), group=WELCOME_GROUP)
...
@Drimicallback(pattern=r"user_join_")
...
@Drimicallback(pattern=r"user_captchajoin_\([\d\-]+,\d+\)_\(\d{4}\)")
...
"""
@Drimicmd(command="lockgroup", pass_args=True)
...
@Drimicmd(command="welcomehelp")
@u_admin
def welcome_help(update: Update, context: CallbackContext):
    update.effective_message.reply_text(WELC_HELP_TXT, parse_mode=ParseMode.MARKDOWN)


@Drimicmd(command="welcomemutehelp")
@u_admin
...
@Drimicallback(pattern=r"wlc_help_")
