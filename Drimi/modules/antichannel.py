...
import Drimi.modules.sql.antilinkedchannel_sql as sql
from Drimi import SUPPORT_CHAT, TOKEN, dispatcher
from Drimi.modules.helper_funcs.anonymous import AdminPerms, user_admin
from Drimi.modules.helper_funcs.chat_status import bot_admin, bot_can_delete
from Drimi.modules.helper_funcs.chat_status import user_admin as u_admin
from Drimi.modules.helper_funcs.decorators import Drimicmd, Drimimsg
from Drimi.modules.sql import acm_sql


@Drimicmd(command="antilinkedchan", group=112)
@bot_can_delete
...
@Drimimsg(Filters.is_automatic_forward, group=111)
...
@Drimicmd(command="antichannelpin", group=114)
@bot_admin
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@Drimimsg(Filters.is_automatic_forward | Filters.status_update.pinned_message, group=113)
def eliminate_linked_channel_msg(update: Update, _: CallbackContext):
    message = update.effective_message
    chat = update.effective_chat
