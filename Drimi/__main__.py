...
import Drimi.modules.no_sql.users_db as sql
from Drimi import BOT_USERNAME
from Drimi import LOGGER as log
from Drimi import OWNER_ID, OWNER_USERNAME, SUPPORT_CHAT, TOKEN
from Drimi import Zadkiel as pbot
from Drimi import StartTime, dispatcher, telethn, updater

# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from Drimi.modules import ALL_MODULES
from Drimi.modules.helper_funcs.chat_status import is_user_admin
from Drimi.modules.helper_funcs.decorators import Drimicallback, Drimicmd, Drimimsg
from Drimi.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Drimi.modules." + module_name)
...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='sᴜᴘᴘᴏʀᴛ', url='https://t.me/Chatting_hub51'),
...
@Drimicallback(pattern=r"start_back")
@Drimicmd(command="start", pass_args=True)
...
def help_button(update: Update, context: CallbackContext):
    ...
    try:
        if mod_match:
            ...
            # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/Drimi'),
...
@Drimicallback(pattern=r"stngs_")
...
@Drimimsg(Filters.status_update.migrate)
...
if __name__ == "__main__":
    log.info("[𝑫𝒓𝒊𝒎𝒊] →  sᴜᴄᴄᴇssғᴜʟʟʏ ʟᴏᴀᴅᴇᴅ ᴍᴏᴅᴜʟᴇs: " + str(ALL_MODULES))
